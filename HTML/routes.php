...
$routes = [
    ...
    'GET /admin/categories/delete' => 'AdminController@deleteCategory',
    ...
    'POST /admin/orders/update' => 'AdminController@updateOrderStatus',
    'GET /admin/orders/delete' => 'AdminController@deleteOrder',
